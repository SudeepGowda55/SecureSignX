...
async function init() {
  complianceOfficerAddress = await askQuestion(
    "Please enter the Compliance Officer's address: "
  );
  managerAddress = await askQuestion("Please enter the Manager's address: ");
  rl.close();

  console.log("Initializing bot with the following addresses:");
  console.log("Compliance Officer:", complianceOfficerAddress);
